...
export function ReportDetailClient({ reportId, shareLinkTtlHours }: ReportDetailClientProps) {
  ...
  return (
    <main>
      ...
      {report ? (
        <ReportView report={report} shareLinkTtlHours={shareLinkTtlHours} variant="portal" />
      ) : null}
    </main>
  )
}
