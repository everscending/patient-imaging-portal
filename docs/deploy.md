...
| 2026-08-23T15:41:47Z | `ea74ab0` | `017_booking_audit_transactional.sql` applied and recorded in `app_deploy.schema_migrations` (checksum `398374d1…`). Verified live: `book_appointment` wrapper executable by `authenticated`, `book_appointment_impl` locked to its owner. Ledger now holds 20 migrations. |
